...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'XACKER;JUNAID;+13133334412;https://i.imgur.com/wyXaJ6a.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'XACKER;JUNAID;+13133334412;https://i.imgur.com/wyXaJ6a.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'XACKER;JUNAID' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '13133334412,0',
       DEBUG: DEBUG
};
